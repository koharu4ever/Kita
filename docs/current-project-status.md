...
ESLint                通过
TypeScript            通过
Vitest                 7 files / 30 tests 通过
Backup shell tests     4 scenarios 通过
GitHub main            f853969（PR #5 已合并）
...
核心功能与生产链路已经建立
  ...
  -> 30 个 Vitest + 4 个 backup shell 场景进入 CI
...
- [x] mapper/server getter/seed 的 30 个 Vitest。
